...
const product = {
  ...
  description: 'শীতের সকালে বা অফিসে চা–কফির সময় গরম পানি চাই এই স্মার্ট হিটার জগ দিচ্ছে আপনাকে ৫৫° অটো টেম্পারেচার কন্ট্রোল সুবিধা — পানি থাকবে গরম, আর আপনার দিন হবে আরও আরামদায়ক ☕🏠 গৃহিণী, অফিস ব্যবহারকারী ও ছাত্রছাত্রী — সবার জন্য পারফেক্ট',
  price: '১,৬৫০',
  regularPrice: '২,৩৫০',
  images: [
     img1,
